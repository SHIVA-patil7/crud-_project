...
SECRET_KEY = 'django-insecure-rt=pamd2o8_-3h9vvy6-977@qort6a(-mz&olvivi(sxh9lldm'
...
# Directory where Django will collect all static files when you run `collectstatic` command
